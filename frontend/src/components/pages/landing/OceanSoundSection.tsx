...
export default function OceanSoundSection() {
    return (
        <RevealSection id="ocean-sound" className="relative min-h-screen px-6 py-20" delay={0.3}>
            <div className="mx-auto w-full max-w-7xl flex gap-5 flex-col lg:items-center lg:justify-between lg:flex-row">
                <div>
                    ...
                    <div className="mt-10 space-y-5">
                        <article className="flex gap-2 items-center rounded-3xl border border-white/20 backdrop p-5">
