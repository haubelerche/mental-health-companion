...
export default function BreathSection() {
    return (
        <RevealSection className="px-6 py-30" id="breath-space" variant="zoom">
                ...
                <div className="flex justify-center">
                    <div className="relative flex items-center justify-center">
                        ...
                        <div className="absolute w-50 h-50 rounded-full border border-white/20 flex items-center justify-center bg-white/20 backdrop-blur-xl">
                            <div className="w-30 h-30 rounded-full bg-white/10 backdrop-blur-xl border border-white/10 flex items-center justify-center hover:bg-white/20 transition pointer">
                                <Waves size={50} />
                            </div>
                        </div>
                    </div>
