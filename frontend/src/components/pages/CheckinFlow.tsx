...
export function CheckinFlow() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      setStep('summary')
      // Show streak celebration after short delay
  ...
  return (
    <div className="min-h-screen bg-white/45 px-4 pb-12 pt-7 text-serene-ink backdrop-blur-xl sm:px-6">
      <StreakCelebration
        ...
        onClaim={() => { setShowStreak(false); navigate(ROUTE_PATHS.home) }}
      />
        ...
        {step === 'mood' && (
          <motion.div key="mood" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="mx-auto w-full max-w-[460px]">
            ...
            <section className="rounded-[30px] border border-white/45 bg-white/65 p-6 shadow-[0_20px_60px_rgba(72,87,121,0.14)] backdrop-blur-xl">
              <h2 className="mb-5 text-4xl font-semibold leading-tight">Hôm nay bạn cảm thấy thế nào?</h2>
            ...
            <p className="mt-5 text-lg text-serene-muted">Tâm trạng là trạng thái cảm xúc chung kéo dài trong một khoảng thời gian.</p>
            <button
              type="button"
          ...
          <motion.div key="emotions" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0 }} className="mx-auto w-full max-w-[460px]">
            ...
            <section className="rounded-[30px] border border-white/45 bg-white/65 p-6 shadow-[0_20px_60px_rgba(72,87,121,0.14)] backdrop-blur-xl">
              <div className="mb-4 flex items-center justify-between">
                <h2 className="text-4xl font-semibold leading-tight">Cảm xúc nào phản ánh bạn nhất lúc này?</h2>
                <button
                  type="button"
            ...
            <p className="mt-5 text-lg text-serene-muted">
              Cảm xúc là phản ứng tức thời — như vui, giận, hay buồn — với một sự kiện hoặc trải nghiệm.
            </p>
        ...
        {step === 'summary' && selectedMood && (
          ...
          >
            ...
            <p className="mt-4 text-xl text-serene-muted">
              Tâm trạng: <span className="font-semibold text-serene-ink">{MOOD_CATEGORIES[selectedMood].label}</span>
            </p>
            ...
            {selectedEmotions.length > 0 && (
              <div className="mt-6">
                <p className="mb-2 text-sm uppercase tracking-[0.22em] text-serene-primary/60">Cảm xúc</p>
