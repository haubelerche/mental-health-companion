...
const TRIGGER_ICONS: Record<string, { icon: React.ComponentType<{ className?: string }>; iconColor: string; bgColor: string }> = {
    default: { icon: AlertCircle, iconColor: 'text-amber-500', bgColor: 'bg-amber-50/70 dark:bg-amber-400/8 border-amber-200/60' },
    deadline: { icon: Mountain, iconColor: 'text-amber-500', bgColor: 'bg-amber-50/70 dark:bg-amber-400/8 border-amber-200/60' },
    học: { icon: Mountain, iconColor: 'text-amber-500', bgColor: 'bg-amber-50/70 dark:bg-amber-400/8 border-amber-200/60' },
    ngủ: { icon: Moon, iconColor: 'text-indigo-400', bgColor: 'bg-indigo-50/70 dark:bg-indigo-400/8 border-indigo-200/60' },
    ăn: { icon: Coffee, iconColor: 'text-emerald-500', bgColor: 'bg-emerald-50/70 dark:bg-emerald-400/8 border-emerald-200/60' },
    bữa: { icon: Coffee, iconColor: 'text-emerald-500', bgColor: 'bg-emerald-50/70 dark:bg-emerald-400/8 border-emerald-200/60' },
    gia: { icon: Users, iconColor: 'text-rose-400', bgColor: 'bg-rose-50/70 dark:bg-rose-400/8 border-rose-200/60' },
    bạn: { icon: Users, iconColor: 'text-rose-400', bgColor: 'bg-rose-50/70 dark:bg-rose-400/8 border-rose-200/60' },
    việc: { icon: BookOpen, iconColor: 'text-purple-400', bgColor: 'bg-purple-50/70 dark:bg-purple-400/8 border-purple-200/60' },
    công: { icon: BookOpen, iconColor: 'text-purple-400', bgColor: 'bg-purple-50/70 dark:bg-purple-400/8 border-purple-200/60' },
}
...
export function ChallengeCards({ summary, checkins: _checkins, matrix }: Props) {
    const cards = buildChallengeCards(summary, matrix)
                        ...
                        >
                            <div className="mb-2 flex items-center gap-2">
                                ...
                                <div className="min-w-0">
                                    <h3 className="text-sm font-semibold text-theme-text-primary leading-snug truncate">
                                        {card.title}
                                    </h3>
