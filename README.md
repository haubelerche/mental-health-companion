...
| **AutoCBT** | Hỗ trợ tái cấu trúc nhận thức (CBT) theo từng bước có hướng dẫn |
...
├── docs/
│   ├── PRD.md                   # Canonical product spec (v6.2)
│   ├── ARCHITECTURE.md          # System architecture + data flow
│   └── EVALUATION_EVIDENCE.md  # Evaluation results + evidence
