...
- **Tính năng:**
  ...
  - **Render thẻ cứu hộ tĩnh:** Hotline thật (ví dụ **1900 1267** cấp cứu trầm cảm BV Tâm thần TP.HCM, **096 306 1414** Ngày Mai, … — danh sách trong `app/data/vn_hotlines.py`), bản đồ phòng khám/bệnh viện gần nhất (Folium)
