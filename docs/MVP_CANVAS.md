...
- **Vai trò:** Nhân vật duy nhất người dùng nhìn thấy (Serene) — tạo phản hồi thấu cảm, tự nhiên theo phong cách Gen Z.
- **Tính năng:**
  ...
  - Viết lại "Lời nhắn tuần của Serene" từ tổng hợp của Analyst (weekly summary, temp 0.4)
...
| **Weekly Note của Serene** | Tổng kết tuần cá nhân hóa | Analyst tổng hợp → Friend rewrite (temp 0.4) |
...
- **Disclaimer bắt buộc:** User tick xác nhận "Serene là AI, không thay thế chuyên gia" khi đăng ký
