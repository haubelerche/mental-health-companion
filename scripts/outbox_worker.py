...
class OutboxWorker:
    ...
    def __init__(self, pg_pool: asyncpg.Pool, neo4j_driver: AsyncDriver) -> None:
        self._pg = pg_pool
        self._applier = Neo4jApplier(neo4j_driver)
        self._running = False
...
async def run_worker(database_url: str, neo4j_uri: str, neo4j_user: str, neo4j_password: str) -> None:
    ...
    worker = OutboxWorker(pg_pool, neo4j_driver)
    try:
        await worker.start()
    finally:
        await pg_pool.close()
