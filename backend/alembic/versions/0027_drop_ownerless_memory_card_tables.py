"""Drop ownerless retired memory-card tables (forward-only cleanup).

Revision ID: 0027_drop_memory_cards
Revises: 0026_screening_raw_contract
...
revision = "0027_drop_memory_cards"
down_revision = "0026_screening_raw_contract"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    raise RuntimeError(
        "0027_drop_ownerless_memory_card_tables is intentionally irreversible. "
