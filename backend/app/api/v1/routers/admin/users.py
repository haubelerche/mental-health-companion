...
def admin_list_users(
    ...
    return ok({
        "users": [{
            ...
            "last_active": u.last_active.isoformat() + "Z"
        } for u in users],
        "total": total or 0
    })
...
def admin_user_detail(
    ...
    return ok({
        ...
        "clinical": {
            ...
            "updated_at": clin.updated_at.isoformat() + "Z" if clin else None,
        },
        "economy": {
        ...
        "latest_mood": {
            ...
            "logged_at": latest_mood.logged_at.isoformat() + "Z" if latest_mood else None,
        },
        "stats": {
