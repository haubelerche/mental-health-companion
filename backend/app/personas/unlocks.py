"""Persona unlock state persistence.

Manages PersonaUnlockState rows — created lazily per user per unlockable persona.
purchase_service calls mark_persona_unlocked after a successful purchase.
route_persona reads is_unlocked from get_persona_unlock_state.
"""
